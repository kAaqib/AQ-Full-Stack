...
const ConfigHelper_1 = __importDefault(require("../../../../utils/ConfigHelper"));
...
class AnalyzeBuilder extends BaseBuilder_1.default {
    constructor(project) {
        super('Analyze', project);
    }
    async generate() {
        let document = DocumentationCache_1.default.getProject();
        if (document)
            return;
        let project_path = App_1.default.Project.project_path;
        let entry_file = ConfigHelper_1.default.get('entry_file');
...
exports.default = AnalyzeBuilder;
//# sourceMappingURL=AnalyzeBuilder.js.map